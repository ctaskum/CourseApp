 ...
 if($_SERVER["REQUEST_METHOD"]== "POST")
{
    ...
    if(empty($courseNameErr) && empty($AltbaslikErr) && empty($resimErr)  && empty($categoryErr)){
        createCourse($courseName,$Altbaslik,$resim,$categoryId);
        $_SESSION["message"]=$courseName." isimli kurs eklendi";
            ...
            <div class="col">
                <form  method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" name="CourseName" id="CourseName" class="form-control" value="<?php echo $courseName; ?>">
                        <div class="text-danger"><?php echo $courseNameErr; ?></div> 
                    </div>
                    <div class="mb-3">
                        <label for="AltBaslik" > Alt Başlık </label>
                        <input type="text" name="AltBaslik" id="AltBaslik" class="form-control" value="<?php echo $Altbaslik; ?>">
                    ...
                    <button type="submit" class="btn btn-primary" id ="categoryCreate">Ekle</button>
